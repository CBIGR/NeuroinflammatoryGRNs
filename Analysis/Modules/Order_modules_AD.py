...
expression_location = "/home/hanne/MyFiles/Master/Processed_counts_AD_GS.txt"
mvf = "/home/hanne/MyFiles/Master/Ens_Anno_Diagn_AD" # module viewer file for annotation
plot_folder = "/home/hanne/MyFiles/Master/ModulesAD"
...
with open("/home/hanne/MyFiles/Master/kmed_modules_MV_AD.txt", 'r') as handle:
    modules = {}
    for line in handle:
        line = line.rstrip()
        module = line.split()[0]
...
# Read expression data and calculate average expression per sample for each module
module_p_values = {}    
...
for module in modules: # Loop through each module
    ...
    group1_samples = [key for key, value in annotations.items() if value == '#CC6677'] # in mvf: if sample has red annotation --> one group, so patients
...
df.to_csv('/home/hanne/MyFiles/Master/p_values_AD.csv', header=True)
...
df.to_csv('/home/hanne/MyFiles/Master/p_values_FDR_AD.csv', header=True)
